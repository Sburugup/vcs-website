      ...
      <footer className="bg-blue-900 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-4">
            <a href="#" className="hover:text-orange-400 transition duration-300">Facebook</a>
            <a href="#" className="hover:text-orange-400 transition duration-300">Twitter</a>
            <a href="#" className="hover:text-orange-400 transition duration-300">LinkedIn</a>
            <a href="#" className="hover:text-orange-400 transition duration-300">Instagram</a>
          </div>
        </div>
      </footer>
    </div>
